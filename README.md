...
Maintained by a SOC Analyst (Detection & Response) actively transitioning into AI security specialisation.
...
The goal is not to be theoretical. Every note here is written with a detection or response angle in mind.
